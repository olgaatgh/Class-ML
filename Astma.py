...
#data_X = np.delete(data_X,[8,9,10,13,14,15,11,12,15,17,18,19,20],1)
...
#clf = clf.fit(X_train,y_train)
##################################
# To study the importance of the features:
...
#for f in range(15):
#    print " %d. feature %d" % (f + 1, indices[f]),feature_names[indices[f]],importances[indices[f]]
...
#
#
#title = "Learning Curves (Random Forest (10))"
...
#X_train, X_test, y_train, y_test = train_test_split(data_X, data_y, test_size = 0.3, random_state = 33)
